  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setStatus({ type: 'error', message: data.message || 'Erro ao enviar mensagem. Tente novamente.' })
      }
    } catch (err) {
      console.error('Fetch error:', err)
      setStatus({ type: 'error', message: 'Erro ao conectar com o servidor. Verifique sua conexão.' })
    } finally {
      setIsLoading(false)
    }
  }
    ...
    <div className="contact-page">
      <div className="contact-container">
        ...
        <div className="contact-cards">
          <a href="https://wa.me/5592996214595" className="contact-card whatsapp">
